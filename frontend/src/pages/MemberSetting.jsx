  ...
  overflow-y-auto z-0 pt-10">
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden relative">
        ...
        <div className="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white">
          ...
          <button
            onClick={() => openModal()}
            className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg font-medium transition-all shadow-md shadow-blue-200 active:scale-95"
          >
            <Plus size={18} />
            Add Member
          </button>
      ...
      {/* ✅ 3. วาง Component Modal แจ้งเตือน/ยืนยัน ตัวใหม่ไว้ท้ายสุด */}
      <ActionFeedbackModal
